...
const learningRoutes = ['/writing/', '/reference/', '/labs/', '/labs/dreamhack/', '/labs/web/', '/labs/crypto/', '/labs/system/'];
...
if (!homepage.includes('href="/reference/"')) errors.push('homepage does not link to the reference hub');
